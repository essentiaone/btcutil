...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/essentiaone/btcutil/coinset)
...
```bash
$ go get -u github.com/essentiaone/btcutil/coinset
```
